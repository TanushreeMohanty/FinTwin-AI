...
const AuthScreen = ({ onGoogleLogin }) => (
  <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-6 text-white text-center">
    ...
    <h1 className="text-3xl font-bold mb-2">SmartSpend AI</h1>
    ...
    <div className="w-full max-w-sm">
        ...
        <button 
            ...
            className="w-full bg-white text-slate-700 py-3 rounded-xl font-bold text-lg hover:bg-gray-100 transition-colors shadow-lg flex items-center justify-center gap-3"
        >
